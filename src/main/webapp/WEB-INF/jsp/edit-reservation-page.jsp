...
<script>
function callInit(){
	var foodArr='${reservation.food}'.split(",");
	for(var i=0;i<foodArr.length;i++){
		$("input[type=checkbox][value='"+foodArr[i]+"']").prop("checked",true);
	}	
}
</script>
</head>  
...
<body onload="callInit()">  
    ...
    <form:form action="/updateBooking" modelAttribute="reservation" method="post">  
    	<form:hidden path="id" value="${reservation.id}" />
        <table border="1" class="table">
        	...
        	<tr>
        		<td>Meals ${reservation.id} ${reservation.food}</td>
        		<td>
