...
<body>
	...
	<table border=1 class="table">
		...
		<tr>
			<td width="40%">Student Entry Form</td>
			<td  width="40%"><a href="/studentEntryForm">Click Here</a></td>
		</tr>		
		<tr>
			<td width="40%">View All Students</td>
			<td  width="40%"><a href="/viewAllStudents">Click Here</a></td>
		</tr>
		<tr>
			<td width="40%">View Students By Id</td>
